...
export default function Edit({ attributes, setAttributes }) {
    const { linkType, pageLink, externalLink, popupId, selectionType } = attributes;
            ...
            <InspectorControls>
                <PanelBody title={__('Column Settings', 'sterlingpt')}>
                    ...
                    <RadioControl
                        ...
                        options={[
                            { label: __('Popup', 'sterlingpt'), value: 'popup' },
                            { label: __('Page or Link', 'sterlingpt'), value: 'page-or-link' },
                        ]}
                        onChange={(value) => setAttributes({ selectionType: value })}
                    />

                    {/* Popup ID Field */}
                    {selectionType === 'popup' && (
                        <TextControl
                            label={__('Popup ID', 'sterlingpt')}
                            value={popupId}
