		...
		<>
	        ...
	        <div { ...useBlockProps({ className: 'alignfull' }) }>
	            <InnerBlocks
	                template={[
                        ['core/column', {
                                className: 'icon-box-layout-three',
                                style: {
                                    color: { background: 'var(--wp--preset--color--white)' },
                                    border: { radius: 'var(--wp--custom--settings-key--border-radius)', color: 'var(--wp--preset--color--primary-100)', width: '1px', style: 'solid' },
                                    spacing: {
