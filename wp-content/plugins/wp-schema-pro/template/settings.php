							...
							<div class="inside">
								...
								<form method="post" action="options.php">
									...
									<table class="form-table">
										...
										<?php
										$brand_bread = isset(BSF_AIOSRS_Pro_Helper::$settings['wp-schema-pro-branding-settings']) && is_array(BSF_AIOSRS_Pro_Helper::$settings['wp-schema-pro-branding-settings']) ? BSF_AIOSRS_Pro_Helper::$settings['wp-schema-pro-branding-settings'] : [];
